...
function Navbar(props) {
  ...
  // Get the theme from localStorage or use the default 'dark' theme
  ...
  // Apply the theme class to the body on component mount and theme change
  useEffect(() => {
  ...
  function toggleTheme() {
    setTheme((currentTheme) => themeMap[currentTheme]);
  }
  ...
  return (
    <nav className="navbar">
      <ul className="navbar-nav">
        <li className="logo">
          <a href="#" className="nav-link" onClick={() => handleNavigate('/home')} >
            <span className="link-text logo-text">Hi {firstName.length !== 0 ? firstName : `User`}!</span>
            {windowWidth >= 600 ? 
            <svg
              aria-hidden="true"
              focusable="false"
        ...
        <li onClick={() => handleNavigate('/browse')} className="nav-item">
        ...
        <li onClick={() => handleNavigate('/bookmarks')} className="nav-item">
          <a href="#" className="nav-link">
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              height="2em" 
        ...
        <li onClick={() => handleNavigate('/messages')} className="nav-item">
          <a href="#" className="nav-link">
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              height="2em" 
      ...
      {/*Themes*/}
        <li className="nav-item" id="themeButton">
          <a href="#" className="nav-link" onClick={toggleTheme}>
            {getThemeIcon()}
